...
const getMyOrders = async (req, res) => {
    try {
        // Yahan bhi 'Order' model use karein
...
const getOrder = async (req, res) => {
    try {
        // Fix: 'orderModel' ki jagah 'Order' use karein
...
module.exports = { addOrderItems, getMyOrders, getOrder, updateOrderStatus };